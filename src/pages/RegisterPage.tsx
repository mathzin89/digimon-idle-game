    ...
    <div className="min-h-screen bg-digi-dark relative flex items-center justify-center overflow-hidden py-12">
      ...
      <div className="relative z-10 w-full max-w-md bg-slate-900/80 border border-digi-cyan/30 p-8 rounded-2xl shadow-[0_0_50px_rgba(0,229,255,0.05)] backdrop-blur-md">
         ...
         <form onSubmit={handleRegister} className="flex flex-col gap-4">
            <div>
               ...
               <input 
                 ...
                 className="w-full bg-slate-950/60 border border-slate-600 rounded px-4 py-2.5 text-slate-100 font-semibold text-sm focus:outline-none focus:border-digi-cyan focus:bg-slate-900 transition shadow-inner" 
            ...
            <div>
               ...
               <input 
                 ...
                 required
                 value={tamerId}
                 onChange={(e) => setTamerId(e.target.value)}
                 className="w-full bg-slate-950/60 border border-slate-600 rounded px-4 py-2.5 text-slate-100 font-semibold text-sm focus:outline-none focus:border-digi-cyan focus:bg-slate-900 transition shadow-inner" 
                 placeholder="Ex: TaiKamiya" 
               />
            </div>
            ...
            <div className="w-full block mt-4">
              <Button 
                ...
                type="submit" 
                disabled={loading}
                className="w-full py-3.5 text-base font-black disabled:opacity-50"
              >
         ...
         <div className="mt-8 text-center text-sm font-semibold text-slate-500">
            ...
            <Link to="/login" className="text-digi-cyan hover:text-white transition hover:underline">
              Fazer Login
            </Link>
         </div>
         <div className="mt-4 text-center">
            <Link to="/" className="text-[10px] font-bold text-slate-600 hover:text-slate-400 transition uppercase tracking-wider">
